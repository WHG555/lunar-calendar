    ...
    <div class="center bg">
      <div class="border-bottom">
        <div>
          ...
          <div  class="text-set">{{ I18n.getMessage('label.gongLi') }} {{ state.year }}{{ I18n.getMessage('label.nian') }} {{ state.month }}{{ I18n.getMessage('label.yue') }}{{ state.day }}{{ I18n.getMessage('label.ri') }} {{ I18n.getMessage('my.week') }}{{ state.weekInChinese }} 
          </div>
          <div class="text-set">{{ I18n.getMessage('label.nongLi') }} {{ state.lunarYearInChinese }}{{ I18n.getMessage('label.nian') }} {{ state.lunarMonthInChinese }}{{ I18n.getMessage('label.yue') }}{{ state.lunarDayInChinese }}</div>
        </div>
      </div>
      <div class="grid">
...
.sbox {
  ...
  box-shadow:  7px 7px 6px var(--inter-color-background),
              -7px -7px 6px var(--inter-color-background-alt);
}
...
.calendar {
  ...
  width: 100%;
  //border: 0px solid #F6D07B;
  display: flex;
  flex-direction: row;
  box-shadow:  7px 7px 6px var(--color-base-50),
              -7px -7px 6px var(--color-base-30);
  border-radius: 10px;
